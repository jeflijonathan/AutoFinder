...
class EditWorkshopForm {
  static String? phone(String? value) {
    if (value == null || value.isEmpty) return 'Phone number cannot be empty';
    return ValidationBuilder().phone('Format phone number is invalid').build()(
      value,
    );
  }
  ...
  static String? mission(String? value) {
    ...
    return ValidationBuilder().minLength(10, 'Minimum 10 characters').build()(
      value,
    );
  }
}
