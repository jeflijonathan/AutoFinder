const Map<String, dynamic> langJA = {
  ...
  'writeReview': 'レビューを書く',
  'noReviewsYet': 'まだレビューはありません。最初のレビューを！',
  'customerLabel': 'お客様',
  'editLabel': '編集',
  'deleteLabel': '削除',
  'replyLabel': '返信',
  'cancelLabel': 'キャンセル',
  'deleteReviewTitle': 'レビューを削除しますか？',
  'deleteReviewContent': '削除されたレビューは復元できません。',
  'rateExperienceInstruction': 'このワークショップでの体験を評価してください',
  'updateExperienceInstruction': '評価と体験を更新',
  'reviewFieldHint': 'このワークショップでの体験について教えてください...',
  'submitReview': 'レビューを送信',
  'editReviewTitle': 'レビューを編集',
  'replyReviewTitle': 'レビューに返信',
  'replyFieldHint': 'ここに返信を入力してください...',
  'sendReply': '返信を送信',
};
