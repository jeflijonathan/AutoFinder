const Map<String, dynamic> langZH = {
  ...
  'deleteReviewContent': '删除的评价无法恢复。',
  'rateExperienceInstruction': '评价您对该车间的体验',
  'updateExperienceInstruction': '更新您的评分和体验',
  'reviewFieldHint': '告诉我们您在该车间的体验...',
  'submitReview': '提交评价',
  'editReviewTitle': '编辑评价',
  'replyReviewTitle': '回复评价',
  'replyFieldHint': '在此输入您的回复...',
  'sendReply': '发送回复',
};
